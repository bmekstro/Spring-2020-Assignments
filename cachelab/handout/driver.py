...
def main():
    ...
    if autograde:
        print (f"{{ \"scores\": {{ \"csim\": {csim_cscore[0]:.2f}, \"trans32\": {trans32_score:.2f}, \"trans64\": {trans64_score:.2f}, \"trans61\": {trans61_score:.2f} }}, \"scoreboard\": [ {miss32}, {miss64}, {miss61}, {total_score:.2f} ] }}");
